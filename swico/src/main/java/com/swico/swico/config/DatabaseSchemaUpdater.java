...
public class DatabaseSchemaUpdater {
    ...
    public void updateSchema() {
        ...
        jdbcTemplate.execute("ALTER TABLE IF EXISTS daily_production_reports ADD COLUMN IF NOT EXISTS daily_target_quantity numeric(10,2)");
        jdbcTemplate.execute("ALTER TABLE IF EXISTS daily_production_reports ADD COLUMN IF NOT EXISTS daily_target_efficiency numeric(10,4)");
        jdbcTemplate.execute("ALTER TABLE IF EXISTS daily_production_reports ALTER COLUMN daily_target_efficiency TYPE numeric(10,4)");
