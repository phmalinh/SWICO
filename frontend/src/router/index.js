...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'master/employee-skills', name: 'EmployeeSkills', component: () => import('@/views/master/EmployeeSkills.vue'), meta: { title: 'routes.employeeSkills', roles: ['ROLE_MANAGER','ROLE_ADMIN'] } },
